  ...
  Daftar Komentar
    ...
    <section class="content">
		...
		<div class="row">
		    ...
		    $query = mysqli_query($koneksi, "SELECT * FROM tbl_komentar as a INNER JOIN tbl_konsumen as b 
		    ...
		    ?>
				...
				<?php  
		        // fungsi query untuk menampilkan data dari tabel komentar
		        $query2 = mysqli_query($koneksi, "SELECT * FROM tbl_komentar as a INNER JOIN tbl_konsumen as b 
                                            	ON a.id_konsumen=b.id_konsumen 
    		...
    		?>
    			<hr>
				<!--PAGE CONTENT BEGINS-->
				<form class="form-horizontal" role="form" action="proses_komentar.php?act=insert" method="POST" />
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-20 col-md-12">
							<input style="width:100px" type="submit" class="btn btn-success" name="balas" value="Balas" />
							&nbsp; &nbsp; 
							<a style="width:100px" href="modules/komentar/proses.php?act=update_status&id=<?php echo $_GET['id']; ?>" class="btn btn-danger">Kembali</a>
						</div>
					</div>
				</form>
				<!--PAGE CONTENT ENDS-->
