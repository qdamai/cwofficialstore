                                ...
                                <form class="form-horizontal" method="POST" action="pages/transaksi/proses_beli.php" name="frmBeli">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
                                            <input style="width:100px" type="submit" class="btn btn-primary btn-submit" name="simpan" value="Beli">
                                            &nbsp; &nbsp; 
                                            <a style="width:100px" href="?page=home" class="btn btn-danger">Batal</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
