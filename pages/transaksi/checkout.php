        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="">
                        <a style="width:110px" href="?page=keranjang" class="btn btn-danger"> <i class=" fa fa-back"> Kembali </i></a>
                        &nbsp; &nbsp; 
                        <a href="pages/transaksi/proses_order.php?id_barang=<?php echo $id_barang; ?>&jumlah_beli=<?php echo $jumlah_beli; ?>&jumlah_bayar=<?php echo $jumlah_bayar; ?>&total_pembayaran=<?php echo $total_pembayaran; ?>" class="btn btn-primary pull-right"> Proses Pesan</i></a>
                    </div>
                </div> <!-- /.col -->
            </div> <!-- /.row -->
        </div>
