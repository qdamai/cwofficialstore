...
<div class="row">
  <div class="col-lg-12"><div class="row"><div class="col-lg-12">
  
  <div class="row">
            <div class="col-lg-12">
                <h3 align="center" class="page-header"><strong>Produk CW Offcial Store </strong> </h3>
            </div>
                ...
                $query = mysqli_query($mysqli, "SELECT * FROM tbl_barang ORDER BY id_barang DESC LIMIT $mulai, $batas")
            ...
            <div class="col-sm-6 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div style="border-top:1px solid #eee;margin-top:10px" class="caption">
                                ...
                                ?>
                                    <a style="width:80px" href="?page=detail&produk=<?php echo $data['id_barang']; ?>" class="btn btn-warning" role="button"> Detail</a>
                                </p>
                            </div>
                        </div>
          </div>
                ...
                <div class="row text-center">
                    <div class="col-lg-12">
                        ...
                        <?php
                            ...
                            <li> 
                                <a href="?page=terbaru&hal=<?php echo $page -1 ?>">&laquo;</a>
                            </li>
                        <?php
                        }
                        ?>
                        ...
                        for($x=1; $x<=$halaman; $x++) { ?>
                            <li class="">
                                <a href="?page=terbaru&hal=<?php echo $x ?>"><?php echo $x ?></a>
                            </li>
                        <?php
                        }
                        ?>
                        ...
                        <?php
                            ...
                            <li>
                                <a href="?page=terbaru&hal=<?php echo $page +1 ?>">&raquo;</a>
                            </li>
                        <?php
                        }
                        ?>
